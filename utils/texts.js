const texts = {
  actions: {
    ...
    error: {
      error: "Something went wrong while processing your request. Please try again. We've logged the error for further review, but if the issue persists or you need immediate help, contact @arttukaup on Telegram."
    }
  },
  terms: {
